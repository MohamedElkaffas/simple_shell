 ...
 *
 * @input: input string for swap
 * @b: type of swap on the string
 * Return: string after swaping
 */
char *swap_char(char *input, int b)
{
	int index;
 ...
 * @h_l: head of command lines list
 * @input: input string
 * Return: no return
 */
